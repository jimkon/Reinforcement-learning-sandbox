...
print("DEFAULT_STORE_DATABASES_DIRECTORY_PATH", DEFAULT_STORE_DATABASES_DIRECTORY_PATH)
DEFAULT_STORE_DATABASE_OBJECT_PATH = os.path.normpath(os.path.join(DEFAULT_STORE_DATABASES_DIRECTORY_PATH, 'rl.db'))
print("DEFAULT_STORE_DATABASE_OBJECT_PATH", DEFAULT_STORE_DATABASE_OBJECT_PATH)
